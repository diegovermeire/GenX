...
"""
Turns homogenous timesteps of TDR timeseries into Heterogenous timeseries using DBSCAN clustering algorithm to identify similar consecutive hours
This function considers in the DBSCAN approach 
    - time indexes 
    - take the maximum values across all similar consecutive time indexes
"""

function HO_TDR_to_HE_DBSCAN_seperate_mean_time(epsilon_values, TDR_HO_path, path_to_save)
    # Define file names
    ...
    for df_tot_rep_period in grouped_dfs
        ...
        norm_exclude = Set(["Rep_Period", "START_SUBPERIODS", "INTERIOR_SUBPERIODS"])
...
# TDR_HO_path = raw"C:\Users\Diego\GenX\GenX.jl-main\example_systems\11_New_England_200928h\TDR_DBSCAN\_qt_rep_period=1_length_rep_period=8736\system_epsilon_0.001"
# path_to_save = "example_systems/11_New_England_200928h/TDR_DBSCAN/_qt_rep_period=1_length_rep_period=8736_eps/DBSCAN_max__time_values"
# epsilon_values = [0.001, 0.45, 1.0]

# HO_TDR_to_HE_DBSCAN_seperate_max_time(epsilon_values, TDR_HO_path, path_to_save)
