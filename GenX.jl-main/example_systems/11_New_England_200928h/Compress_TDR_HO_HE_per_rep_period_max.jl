...
# path_to_save = "example_systems/11_New_England_200928h/TDR_DBSCAN/_qt_rep_period=1_length_rep_period=8736_eps/DBSCAN_max_values"
# epsilon_values = [0.001, 0.45, 1.0]

# HO_TDR_to_HE_DBSCAN_seperate_max(epsilon_values, TDR_HO_path, path_to_save)
