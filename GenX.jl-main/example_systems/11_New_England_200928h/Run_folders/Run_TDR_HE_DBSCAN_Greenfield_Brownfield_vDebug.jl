...
"""
# Files
unique_results_folder_GF = "21_02_TDR_DBSCAN_Greenfield_CO2=2_MC=0_UC=0_LDS=1_Vdebug"
results_folder_BF_writing = "21_02_TDR_DBSCAN_Borwnfield_CO2=2_MC=0_UC=0_LDS=1_Vdebug"
base_folder = "resource_enforce_TDR__DBSCAN_V3"
...
number_repr_period = row.number_rep_period[1]
eps = row.Epsilon[1]
# println("row", comb_df)
...
if (mysetup["TimeDomainReduction"] == 1) && (mysetup["HeterogenousTimesteps"] == 1)
    mysetup["TimeDomainReductionFolder"] = string("TDR_DBSCAN", "_qt_rep_period=", number_repr_period, "_length_rep_period=", time_rep_period)
    println("#########################################################")
    ...
    if !GenX.time_domain_reduced_files_exist(TDRpath)
        ...
        myTDRsetup["MinPeriods"] = INntnumber_repr_period
    ...
    HO_TDR_to_HE_DBSCAN([eps], TDRpath, path_HO_TDR_HE_DBSCAN)
...
if (mysetup["TimeDomainReduction"] == 1) && (mysetup["HeterogenousTimesteps"] == 0)
    mysetup["TimeDomainReductionFolder"] = joinpath("TDR_DBSCAN", string("_qt_rep_period=", number_repr_period, "_length_rep_period=", time_rep_period), string("system_epsilon_", eps))
