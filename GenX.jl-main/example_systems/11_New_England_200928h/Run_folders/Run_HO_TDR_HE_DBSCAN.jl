...
if (mysetup["TimeDomainReduction"] == 1) && (mysetup["HeterogenousTimesteps"] == 0)
    ...
    if !GenX.time_domain_reduced_files_exist(TDRpath)
        ...
        myTDRsetup["MinPeriods"] = 2
        myTDRsetup["MaxPeriods"] = 2
        myTDRsetup["TimestepsPerRepPeriod"] = 8736
...
if (mysetup["TimeDomainReduction"] == 1) && (mysetup["HeterogenousTimesteps"] == 1)
    ...
    HO_TDR_to_HE_DBSCAN(epsilon_values, TDRpath, path_HO_TDR_HE_DBSCAN)
    mysetup["TimeDomainReductionFolder"] = joinpath(string(mysetup["TimeDomainReductionFolder"],"_eps"), string("system_epsilon_", epsilon_values[1]))
...
mysetup["TimeDomainReductionFolder"]
